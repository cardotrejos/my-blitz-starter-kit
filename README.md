...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/my-blitz-starter-kit
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/my-blitz-starter-kit_test
```
